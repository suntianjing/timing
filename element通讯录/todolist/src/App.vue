<template>
  <div class="header">
    ...
    <el-row :gutter="20">
      <el-col :span="6">
        <el-input placeholder="标签名称" v-model="addUser.name" clearable>
        </el-input>
      </el-col>
      <el-col :span="6">
        <!-- <el-input placeholder="状态" v-model="addUser.tel" clearable>
        </el-input> -->
        <el-select v-model="addUser.tel" placeholder="请选择状态">
          <el-option
      ...
      <el-col :span="6">
        <el-input placeholder="关键主题词" v-model="addUser.tips" clearable>
        </el-input>
      </el-col>
    </el-row>
    ...
    >
      ...
      <el-table-column prop="tel" label="状态" width="180"> </el-table-column>
      <el-table-column prop="tips" label="关键主题词" width="280">
      </el-table-column>
